  ...
  render() {
    return (
      <Card.Group>
        ...
        >
          <Image
            src="https://cdn.dribbble.com/users/102974/screenshots/2726841/head_bob.gif"
            wrapped
            ui={false}
          />
          <Card.Content>
            ...
            <Card.Description>Canon Genius </Card.Description>{" "}
          </Card.Content>{" "}
          <Card.Content extra>
            <Button> Book </Button> <Button> Info </Button>{" "}
          </Card.Content>{" "}
        </Card>{" "}
        <Card
          style={{
        ...
        >
          <Image
            src="https://media3.giphy.com/media/aOvWc1m1d9jX2/giphy.gif"
            wrapped
            ui={false}
          />{" "}
          <Card.Content>
